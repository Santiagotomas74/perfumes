...
const Footer = () => {
  return (
    <>
      {/* El fondo se mantiene constante.
      ...
      */}
      ...
      style={{
        ...
        {/* Contenedor principal del footer.
          En móviles, es una sola columna con un espacio vertical pequeño (gap-8).
          En pantallas medianas, cambia a 4 columnas con más espacio (md:grid-cols-4 md:gap-12).
        */}
