...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className="text-gray-600 py-12 px-4 sm:px-6 md:px-24"
        style={{ backgroundColor: "#f2dc7d" }}
      >
        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 md:grid-cols-4 md:gap-12 pb-12">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-bold text-base text-gray-900 mb-4">Santiago Taher</p>
          ...
          <div className="flex flex-col">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Síguenos para ver mas</h3>
            <div className="flex space-x-5 text-2xl">
              <a
                href={whatsappLink2}
                target="_blank"
