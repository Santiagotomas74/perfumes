// CircularGallery (sin efecto "agua")
...
class Media {
  ...
  createShader() {
    ...
    // --- VERTEX SHADER MODIFICADO: eliminamos desplazamiento en Z ---
    const vertex = `
      precision highp float;
      attribute vec3 position;
      attribute vec2 uv;
      ...
      void main() {
        vUv = uv;
        // Sin desplazamiento: posición original
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      }
    `;

    // Fragment se mantiene (sólo redondeado/alpha)
    const fragment = `
      precision highp float;
  ...
  update(scroll, direction) {
    ...
    // --- NO actualizamos uTime/uSpeed aquí (no hay ondulación) ---
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      { image: `https://perfumescardales.com.ar/wp-content/uploads/2025/07/petra-2.jpg`, text: 'Petra' },
      { image: `https://perfumescardales.com.ar/wp-content/uploads/2023/12/honor-1.jpg`, text: 'Bade’e Al Oud Honor & Glory' },
      { image: `https://perfumescardales.com.ar/wp-content/uploads/2023/10/hata-2.jpg`, text: 'Maya' },
      { image: `https://perfumescardales.com.ar/wp-content/uploads/2024/01/leen-4.jpg`, text: 'Leen' },
